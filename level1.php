...
<body>
    ...
    <p>A set of 6 different letters generated randomly is shown below. Please use the form to write them in ascending
        order (from a to z).</p>
    <?php
    ...
    <form method="post">
        ...
        <input type="hidden" name="orginal" id="orginal" maxlength="6" value=<?php echo implode("", $letters) ?>>
    ...
    if (isset($_POST['submit'])) {
        $original_letters = str_split(strtolower($_POST['orginal']));
        ...
        if ($ordered_letters === $original_letters) {
            ...
            echo "<button onclick=\"location.href='level2.php';\">Go to the Next Level</button>";
        }
        ...
        // check if the letters entered are the same as the ones displayed but in the wrong order
        else {
            echo "<p>Incorrect - Your letters have not been correctly ordered in ascending order.</p>";
            echo "<button onclick=\"location.reload();\">Try Again this Level</button>";
