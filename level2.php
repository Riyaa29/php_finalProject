...
<body>
    ...
    <p>A set of 6 different letters generated randomly is shown below. Please use the form to write them in descending
        order (from z to a).</p>
    ...
    <form method="post">
        ...
        <input type="hidden" name="original" id="original" maxlength="6" value=<?php echo implode("", $letters) ?>>
    ...
    if (isset($_POST['submit'])) {
        ...
        // check if the letters entered are the same as the ones displayed but in the wrong order
            ...
            echo "<p>Incorrect - Your letters have not been correctly ordered in descending order.</p>";
            echo "<button onclick=\"location.reload();\">Try Again this Level</button>";
