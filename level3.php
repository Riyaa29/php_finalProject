...
<form method="post">
    ...
    <input type="hidden" name="original" id="original" value="<?php echo implode(',', $numbers); ?>">
...
if (isset($_POST['submit'])) {
    ...
    // check if the numbers entered are the same as the ones displayed but in the wrong order
        ...
        echo "<p>Incorrect - Your numbers have not been correctly ordered in ascending order.</p>";
        echo "<button onclick=\"location.reload();\">Try Again this Level</button>";
